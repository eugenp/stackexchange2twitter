...
class RemoveDuplicateRetweetsUpgrader implements ApplicationListener<AfterSetupEvent>, IRemoveDuplicateRetweetsUpgrader {
        ...
        for (final TwitterAccountEnum twitterAccount : TwitterAccountEnum.values()) {
            if (twitterAccount.isRt()) {
                try {
                    ...
                    final boolean processedSomething = removeDuplicateLocalRetweetsOnAccount(twitterAccount.name());
    ...
    @Override
    public final boolean removeDuplicateLocalRetweetsOnAccount(final String twitterAccount) {
