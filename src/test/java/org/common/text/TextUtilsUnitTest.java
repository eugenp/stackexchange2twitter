...
public class TextUtilsUnitTest {
    ...
    public final void whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters(".htaccess & Wordpress: Exclude folder from RewriteRule");
    ...
    public final void givenTextContainsInvalidCharactersScenario1_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("System(“pause”); - Why is it wrong? - stackoverflow.com/questions/1107");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario2_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("<context:property-placeholder> properties not accessible to the child (web) context");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario3_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("#Akka 2.2.0 FINAL Released — http://tmblr.co/ZlHOLwpD-j-a");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario4_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("What is the difference between an EAR file and a “WebSphere Enhanced EAR”?");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario5_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("Spring Batch Example – XML File To Database");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario6_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("What's the best way to validate an XML file against an XSD file?");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario7_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("Understanding “randomness”");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario8_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("What's the best way to communicate between view controllers?");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario9_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("I&rsquo;m broadcasting #LIVE on #HangWith for #iPhone! Come Hang w/souljaboy! http://bit.ly/hangwsocial");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario10_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("#Google Search&nbsp;API for C# - http://stackoverflow.com/questions/2580396/google-searchapi-for-c");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario11_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("#Akka 2.2 Spotlight: Publish/Subscribe in Cluster… http://tmblr.co/ZlHOLwq2afmO");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
    ...
    public final void givenTextContainsInvalidCharactersScenario12_whenProcessingTweetText_thenCorrectlyProcessed() {
        ...
        final String preProcessedTweet = TextUtils.cleanupInvalidCharacters("What are Unity&#39;s keyboard and mouse shortcuts?");
        assertThat(preProcessedTweet, equalTo(expectedText));
    }
