...
public class RemoveDuplicateRetweetsUpgraderLiveManualTest {
    ...
    public final void whenRecreatingTheRetweetsOfSingleAccount1_thenNoExceptions() {
        removeDuplicateRetweetsUpgrader.removeDuplicateLocalRetweetsOnAccount(TwitterAccountEnum.InTheAppleWorld.name());
    }

    @Test
    public final void whenRecreatingTheRetweetsOfSingleAccount2_thenNoExceptions() {
        removeDuplicateRetweetsUpgrader.removeDuplicateLocalRetweetsOnAccount(TwitterAccountEnum.BestClojure.name());
    }
