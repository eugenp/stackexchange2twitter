...
import org.classification.data.ClassificationData.Other.Reject;
...
public final class RejectTweetsByWordGenericManualTest {

    private String tweet;

    public RejectTweetsByWordGenericManualTest(final String tweet) {
        super();
        this.tweet = tweet;
    }
    ...
    public static List<String[]> invalidWords() throws IOException {
        final InputStream is = GenericClassificationDataUtil.class.getResourceAsStream(Reject.GENERIC);
