...
public final class TwitterUtilBannedForAnalysisByRegexUnitTest {
    ...
    @Test
    public final void givenTweetContainsBannedExpression_whenCheckingScenario_thenRejected() {
        assertTrue(TwitterUtil.isRejectedByBannedRegexExpressionsForAnalysis(tweet));
    }
