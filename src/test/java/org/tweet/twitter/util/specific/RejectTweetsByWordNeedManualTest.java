...
public final class RejectTweetsByWordNeedManualTest {

    private String tweet;

    public RejectTweetsByWordNeedManualTest(final String tweet) {
        super();
        this.tweet = tweet;
    }
    ...
    public static List<String[]> invalidWords() throws IOException {
        final InputStream is = GenericClassificationDataUtil.class.getResourceAsStream("/notes/test/need-toreject.txt");
