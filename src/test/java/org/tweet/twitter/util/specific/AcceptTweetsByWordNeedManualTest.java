...
public final class AcceptTweetsByWordNeedManualTest {

    private String tweet;

    public AcceptTweetsByWordNeedManualTest(final String tweet) {
        super();
        this.tweet = tweet;
    }
    ...
    public static List<String[]> invalidWords() throws IOException {
        final InputStream is = GenericClassificationDataUtil.class.getResourceAsStream("/notes/test/need-toaccept.txt");
