...
public final class RejectTweetsByWordCommercialGenericManualTest {

    private String tweet;

    public RejectTweetsByWordCommercialGenericManualTest(final String tweet) {
        super();
        this.tweet = tweet;
    }
    ...
    public static List<String[]> invalidWords() throws IOException {
        final InputStream is = GenericClassificationDataUtil.class.getResourceAsStream("/notes/test/generic-commercial-toreject.txt");
