...
public final class AcceptTweetsByWordGenericCommercialManualTest {

    private String tweet;

    public AcceptTweetsByWordGenericCommercialManualTest(final String tweet) {
        super();
        this.tweet = tweet;
    }
    ...
    public static List<String[]> invalidWords() throws IOException {
        final InputStream is = GenericClassificationDataUtil.class.getResourceAsStream("/notes/test/generic-commercial-toaccept.txt");
