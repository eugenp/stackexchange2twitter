...
public final class PersonalTweetsBannedForTweetingManualTest {

    private String tweet;

    public PersonalTweetsBannedForTweetingManualTest(final String tweet) {
        super();
        this.tweet = tweet;
    }
    ...
    public static List<String[]> invalidWords() throws IOException {
        final InputStream is = GenericClassificationDataUtil.class.getResourceAsStream("/notes/test/tweeting/tweeting-personal-banned.txt");
