...
public final class InteractionLiveServiceUnitTest {
    ...
    public final void givenUserHasHighSelfMentionRetweetRate_whenDecidingInteractionWithUser_thenMention() {
        ...
        final TwitterInteraction bestInteractionWithUser = instance.decideAndScoreBestInteractionWithUser(new TwitterUserSnapshot(10, 30, selfRetweetPercentage, 20), TweetFixture.createTwitterProfile()).getTwitterInteraction();
